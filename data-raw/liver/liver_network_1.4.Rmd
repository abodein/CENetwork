...
ppi_compound.inter <- CENetwork::combine_layers(ppi_layer.graph, protein_compound_layer)
...
ppi_compound_side_effect <- CENetwork::combine_layers(ppi_compound.inter, sider_drug_layer)
```
...
grn_prot.layer <- CENetwork::combine_layers(graph1 = grn.graph,interaction.df = interaction_gene_prot)
...
gene_ppi_compound_side_effect <- CENetwork::combine_layers(grn_prot.layer, ppi_compound_side_effect)
```
...
gene_ppi_compound_side_effect_pathways <- CENetwork::combine_layers(gene_ppi_compound_side_effect, pathways_interactions.layer)
```
...
gene_ppi_compound_side_effect_pathways_GO <- CENetwork::combine_layers(gene_ppi_compound_side_effect_pathways, go_layer.graph)
```
